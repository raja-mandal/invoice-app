        ...
        <div class="work-items">
          ...
          <table class="item-list">
            ...
            <tr class="table-items flex" v-for="(item, index) in invoiceItemList" :key="index">
              ...
              <img @click="deleteInvoiceItem(item.id)" src="@/assets/trash.png" alt="" />
            </tr>
          </table>

          <div @click="addNewInvoiceItem" class="flex button add-new-item">
...
export default {
  ...
  methods: {
    ...
    async uploadInvoice() {
      ...
      //   alert("Please ansure you filled out work items!")
      //   return;
      //  }
      ...
      const docRef = await addDoc(dataBase, dataObj)
      console.log(docRef)
